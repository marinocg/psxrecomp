...
- `.github/workflows/recompile-demos.yml` runs this script after demo recompilation and includes both inventory and trend snapshot reports in uploaded artifacts.
