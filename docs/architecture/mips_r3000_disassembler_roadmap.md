...
- [x] Add function boundary discovery (prologue/epilogue heuristics).
- [x] Detect jump tables and indirect branch targets.
- [x] Improve code-vs-data segmentation for mixed sections.
